...
<html lang="en">
<head>
    <title>User Management | Optimus</title>
    <meta charset="utf-8">
   <% 
    if(priv != null)
    	if(priv == 1){
                ...
                <ul id="side-menu" class="nav">
						...
						if(priv != null){
							if(priv == 1 || priv == 2){
								...
								if(priv != null){
									if(priv == 1){
									out.print("<li class='active'><a href='users.jsp'><i class='fa fa-user fa-fw'>" +
		                                            ...
		                                            <table class="table table-responsive table-bordered ">
		                                                <thead>
		                                                    <tr>
		                                                        ...
		                                                        <th class="text-center col-md-2 col-lg-2 col-sm-2">Email</th>
		                                                ...
		                                                <tbody>
		                                                    <tr>
		                                                        <td><div class="form-group" id="value-username">
		                                                                <input class="form-control text-center" type="text" id="username">
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-password">
		                                                                <input class="form-control text-center" type="text" id="password">
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-name">
		                                                                <input class="form-control text-center" type="text" id="name">
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-designation">
		                                                                <input class="form-control text-center" type="text" id="designation">
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-email">
		                                                                <input class="form-control text-center" type="text" id="email">
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-gender">
		                                                        		<select class="form-control" id="gender">
                                                                 			<option value="1">Male</option>
                                                                 			<option value="2">Female</option>
                                                                 		</select>
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-mobile">
		                                                                <input class="form-control text-center" type="text" id="mobile">
		                                                            </div></td>
		                                                        <td><div class="form-group" id="value-privilege">
	                                           		...
	                                           		<hr>
	                                           		<button class="btn btn-success" id="submit-values">Add User</button>
		                                        </div>
	                                   		</div>
	                                   		<hr>
	                                   		<div class="row">
