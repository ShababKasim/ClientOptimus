...
<html lang="en">
<head>
    <title>Ticket-Queue | Optimus</title>
    <meta charset="utf-8">
    <% 
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
						...
						out.print("<li><a href='dashboard.jsp'><i " +
                       	...
                       	out.print("<li class='active'><a href='queue.jsp'><i class='fa fa-list fa-fw'> " +
								...
								<div class="panel">
									<div class="panel-body">
										<div class="row">
											...
											<div class="col-lg-10 col-md-10 col-sm-10 main-queue">
												<table class="table table-responsive table-bordered table-striped "
													id="tickets">
													<thead>
														<tr>
															<th class="text-center col-lg-1 col-md-1 col-sm-1">#</th>
															<th class="text-center col-lg-2 col-md-1 col-sm-1">Destination</th>
										...
										<div class="row">
											<div class="col-lg-10 col-md-10 col-sm-10 serving-ticket">
												<h1>Serving Tickets</h1>
												<hr>
												<div class="agv-data">
												</div>
											</div>
