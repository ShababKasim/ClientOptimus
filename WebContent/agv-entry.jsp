...
//     		out.print("<Meta HTTP-EQUIV='refresh' Content='"+ session.getMaxInactiveInterval() +"' URL='Logout.jsp' >");
    ...
    <script src="js/agv-entry.js"></script>
</head>
<body>
    <div>
        <!--BEGIN BACK TO TOP-->
						...
						if(priv != null){
							if(priv == 1 || priv == 2){
								out.print(" <li><a href='map-entry.jsp'><i " +
		                                ...
		                                "Entry</span></a></li>");
								out.print("<li class='active'><a href='agv-entry.jsp'><i class='fa fa-edit fa-fw'>" +
                                       ...
                                       <div class="row">
	                                        <div class="col-lg-8 col-md-8 col-sm-8">
	                                            ...
	                                            <table class="table table-responsive table-bordered ">
	                                                <thead>
	                                                    <tr>
	                                                        <th class="text-center col-md-1 col-lg-1 col-sm-1">Agv Id</th>
	                                                        <th class="text-center col-md-3 col-lg-3 col-sm-3">Agv Name</th>
	                                                        <th class="text-center col-md-2 col-lg-2 col-sm-2">Ip Address</th>
	                                                        <th class="text-center col-md-1 col-lg-1 col-sm-1">Port</th>
	                                                    </tr>
	                                                </thead>
	                                                <tbody>
	                                                    <tr>
	                                                        <td><div class="form-group" id="value-id">
	                                                                <input class="form-control text-center" type="number" id="id">
	                                                            </div></td>
	                                                        <td><div class="form-group" id="value-name">
	                                                                <input class="form-control text-center" type="text" id="name">
	                                                            </div></td>
	                                                        <td><div class="form-group" id="value-ip">
	                                                                <input class="form-control text-center" type="text" id="ip">
	                                                            </div></td>
	                                                        <td><div class="form-group" id="value-port">
	                                                                <input class="form-control text-center" type="number" id="port">
	                                                            </div></td>
	                                                    </tr>
	                                                </tbody>
	                                            </table>
	                                        ...
	                                        <div class="col-md-4 col-lg-4 col-sm-4">
	                                        	...
	                                        	<div class="input-buttons">
		                                            <button class="btn btn-success" id="validate-agv">
		                                                Validate and Add
		                                            </button>
	                                            </div>
	                                            <br>
	                                            <div style="width:100%;height:90px;margin: 0px auto;margin: 20px 0px;background-color: white;border: 1px solid #333;overflow: auto;">
		                        					<div class="console" style="margin-left:10px;margin-top:5px;"></div>
		                        				</div>
	                                        </div>
	                                    </div>
