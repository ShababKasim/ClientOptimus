                ...
                <ul id="side-menu" class="nav">
						...
						if(priv != null){
							if(priv == 1 || priv == 2){
								...
								out.print("<li class='active'><a href='power.jsp'><i class='fa fa-power-off fa-fw'>" +
                        	...
                        	<div class="panel">
                        		<div class="panel-body">
                        			...
                        			<div class="col-lg-5 col-md-5 col-sm-5">
	                        			<button class="btn btn-success" id="power-on"><i class="fa fa-power-off fa-fw"></i>Power On</button>
	                        			<button class="btn btn-danger pull-right"id="power-off"><i class="fa fa-power-off fa-fw"></i>Power Off</button>
                        				<div style="width:100%;height:100px;margin: 0px auto;margin: 20px 0px;background-color: white;border: 1px solid #333;overflow: auto;">
