...
//     		out.print("<Meta HTTP-EQUIV='refresh' Content='"+ session.getMaxInactiveInterval() +"' URL='Logout.jsp' >");
    ...
    <script src="js/map-entry.js"></script>
</head>
<body>
    <div>
        <!--BEGIN BACK TO TOP-->
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
						...
						if(priv != null){
							if(priv == 1 || priv == 2){
								out.print(" <li class='active'><a href='map-entry.jsp'><i " +
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12">
                                <div class="panel">
                                    <div class="panel-body">
                                        <div class="content-type" value="node"></div>

                                        <div class="content-value-node">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                    <table class="table table-responsive table-bordered ">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><div class="form-group" id="value-anchor">
                                                                        <input class="form-control" type="text" id="anchor">
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-xco">
                                                                        <input class="form-control" type="text" id="xco">
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-yco">
                                                                        <input class="form-control" type="text" id="yco">
                                                                    </div></td>
                                                    ...
                                                    <hr>
                                                    <hr>
                                                    <span id="vartype"></span>
                                                </div>
                                                <div class="col-md-3 col-lg-3 col-sm-3">
                                                	<div class="input-button">
	                                                    <button class="btn btn-warning" id="value-input-node">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                    <table class="table table-responsive table-bordered ">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-center col-lg-2 col-md-2 col-sm-2">Source
                                                                    Anc.</th>
                                                                <th class="text-center col-lg-2 col-md-2 col-sm-2">Dest
                                                                    Anc.</th>
                                                                <th class="text-center col-lg-2 col-md-2 col-sm-2">Distance</th>
                                                                <th class="text-center col-md-2">Radius</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td><div class="form-group" id="value-src">
                                                                        <select class="form-control" id="src">
                                                                        </select>
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-dest">
                                                                        <select class="form-control" id="dest">
                                                                        </select>
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-distance">
                                                                        <input class="form-control" type="text" id="distance">
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-radius">
                                                ...
                                                <div class="col-md-3 col-lg-3 col-sm-3">
                                                	<div class="input-button">
	                                                    <button class="btn btn-warning" id="value-input-edge">
	                                                        <i class="fa fa-plus fa-fw"></i>Add
	                                                    </button>
													</div>
                                                </div>
                                        ...
                                        <div class="content-value-business">
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                    <h1>Business Entry</h1>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                    <table class="table table-responsive table-bordered ">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-center col-lg-1 col-md-1 col-sm-1">Id</th>    
                                                                <th class="text-center col-lg-2 col-md-2 col-sm-2">Anchor Id</th>
                                                                <th class="text-center col-lg-5 col-md-5 col-sm-5">Label</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                            	<td><div class="form-group" id="value-nrid">
                                                                        <input class="form-control" type="text" id="nrid">
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-anchor">
                                                                        <select class="form-control" id="anchor">
                                                                        </select>
                                                                    </div></td>
                                                                <td><div class="form-group" id="value-label">
                                                ...
                                                <div class="col-md-3 col-lg-3 col-sm-3">
                                                	<div class="input-button">
	                                                    <button class="btn btn-warning" id="value-input-business">
	                                                        <i class="fa fa-plus fa-fw"></i>Add
	                                                    </button>
													</div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-1 col-md-1 col-sm-1">
                                                <button class="btn btn-primary pull-left" id="pan-previous">
                                                    <i class="fa fa-caret-left fa-fw"></i>Previous
                                                </button>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6"></div>
                                            <div class="col-lg-1 col-md-1 col-sm-1">
                                                <button class="btn btn-primary pull-right" id="pan-next">
